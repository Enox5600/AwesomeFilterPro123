...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1412758888 5230417433 1822479202').split()]
...
UPSTREAM_REPO = environ.get('UPSTREAM_REPO', 'https://github.com/Enox5600/AwesomeFilterPro123')
...
#Sample
SHORTNER_SITE = "https://instantlinks.co"
SHORTNER_API = "900da68005a2ef7cce728147cd8c08e27a12080b"
